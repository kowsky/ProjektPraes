...
Sequenzen mit der Swissprot Datenbank durchgeführt. Diese Referenzergebnisse wurden anschließend in den besten $1000$ Treffern der beiden \emph{SANS}-Algorithmen
...
\begin{figure}
  \begin{center}
    ...
    \caption{Sensitivität des selbst implementierten \emph{SANS}-Algorithmus und dem aus \cite{Holm}. Als Referenz dienen SSearch-Alignments.
