...
Sequenzen mit der Swissprot Datenbank die besten $1000$ Treffer pro Queryprotein ermittelt. Anschließend wurden diese Referenzergebnisse in den besten $1000$ Treffern pro query-Protein der beiden SANS-Algorithmen gesucht, um die true positives festzustellen. Wie in \cite{Holm} erfolgte eine Aufteilung in Identitätsklassen. Abbildung \ref{barplot} zeigt, dass beide Implementierungen eine vergleichbare Sensitivität erreichen.
